...
- Sheet: https://docs.google.com/spreadsheets/d/1ZrLSqkNDWugAl2iLuAnQzihYjSg2wXOEzuxDWkyy4yQ/edit?gid=119065602
- 공유: **링크가 있는 모든 사용자 → 보기** 필요
- 동기화: `npm run generate:works` → `src/lib/works.data.json` 생성 (로컬 CSV 캐시도 `data/`에 저장)
